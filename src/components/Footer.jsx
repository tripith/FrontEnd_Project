  ...
  return (
    <>
      <div className='PreFooter'>
        <div>{repeatIcon}<p><b>Hassle-free-replacement</b><br />10-day easy replacement poilcy on mi.com</p></div>
        <div>{shieldIcon}<p><b>100% secure payments</b><br />We support Card,Wallets,EMI and COD</p></div>
        <div>{mapIcon}<p><b>Vast service network</b><br />1000 Mi service-center across 600 cities</p></div>
      </div>
